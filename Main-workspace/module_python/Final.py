...
while True:
    ...
    # Flip camera
    img = cv2.flip(img, 1)
    cv2.imwrite('Image/human.png', img)
    # Draw landmarks
...
if setpw == enterpw:
    ...
    Control.addTurn("", imgUrl, 0, False, False)
    ...
    with open("PassLog/Log.txt", 'w+', encoding='utf-8') as f:
        #f.write(enterpw + '\n')
        f.writelines("Someone try to open the door! Do you know this person?\n" + dt + " - Access denied!" + '\n' + '\n')
